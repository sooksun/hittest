...
game_result_save($pdo, $me, 'training',
    (int)$session['grade_level'], (int)$session['difficulty'], (int)$session['total_score'],
    ['correctCount' => $session['correct_count'], 'totalTasks' => $session['total_tasks']]);
